...
C_OPTS = -std=c99 -Wall -Ofast -fdata-sections -ffunction-sections -marm -march=armv5te -mtune=arm926ej-s
...
$(BUILD_DIR)/%.o: %.c
	@mkdir -p $(dir $@)
	@$(CCXX) $(ALL_CFLAGS) $(AUTODEPENDENCY_CFLAGS) -c $< -o $@
	@echo CC $<
